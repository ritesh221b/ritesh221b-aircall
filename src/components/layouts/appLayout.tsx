...
export const AppLayout = ({ children }: IAppLayoutProps) => {
  return (
    <div className="flex mx-0 items-end justify-center text-center sm:block sm:px-4 sm:pt-4 sm:pb-32 bg-gradient-to-tr from-indigo-800 to-indigo-500 w-full h-screen">
      ...
      <a
        href="https://github.com/ritesh221b/ritesh221b-aircall"
        target="_blank"
        className="absolute left-0 top-0 hidden sm:block text-indigo-300 font-bold tracking-wide transform px-4 p-2 justify-center"
      >
        @ritesh221b
      </a>
    </div>
